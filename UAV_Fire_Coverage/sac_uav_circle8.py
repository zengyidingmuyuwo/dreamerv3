"""
sac_uav_circle8.py — SAC training for Circle 8 (fire coverage + obstacle avoidance).
...
def main():
    ...
    parser.add_argument('--save_dir', default='./sac_circle8_model')
    ...
    if args.elevation_tif:
        ...
        print(f'Obstacle map loaded; {obs_grid.sum()} obstacle cells')
    else:
        obs_grid, cell_size = make_synthetic_obstacle_map(radius)
        print('Using synthetic obstacle map')
